              ...
              >
                ...
                <SelectContent>
                  ...
                  <SelectItem value="pending">
                    <div className="flex items-center gap-2">
                      <div className="w-2 h-2 rounded-full bg-tacir-yellow"></div>
                      En attente
                    </div>
                  </SelectItem>
                  <SelectItem value="approved">
                    <div className="flex items-center gap-2">
                      <div className="w-2 h-2 rounded-full bg-tacir-green"></div>
                      Approuvé
                    </div>
                  </SelectItem>
                  <SelectItem value="rejected">
                    <div className="flex items-center gap-2">
                      <div className="w-2 h-2 rounded-full bg-tacir-pink"></div>
                      Rejeté
                    </div>
                  </SelectItem>
                  <SelectItem value="rescheduled">
                    <div className="flex items-center gap-2">
                      <div className="w-2 h-2 rounded-full bg-tacir-orange"></div>
                      Reprogrammé
                    </div>
                  </SelectItem>
                </SelectContent>
          ...
          <div className="mt-4 pt-4 border-t border-tacir-lightgray">
            <div className="flex flex-wrap gap-2">
              ...
              {filters.status && filters.status !== "all" && (
                <span className="inline-flex items-center gap-1 px-2 py-1 bg-tacir-yellow text-white text-xs rounded-full">
